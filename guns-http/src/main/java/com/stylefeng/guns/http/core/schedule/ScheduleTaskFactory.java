...
public class ScheduleTaskFactory {
	 ...
	 * @return
	 */
	public static TimerTask sendNewAppointmentReminder(final Integer projectid, final String commitDate, final String remark) {
		return new TimerTask() {
			...
			public void run() {
				...
				try {
					...
					templateUtil.sendNewAppointmentReminder(project.getXmmc(), commitDate, remark);
				} catch (Exception e) {
